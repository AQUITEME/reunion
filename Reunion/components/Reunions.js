...
export default function ListReunions({navigation}){
    ...
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={getReunion} style={styles.refresh}>
                <Text style={{color:'white'}}>Click to refresh your list</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.pop} onPress={()=>{navigation.navigate("Ajouter une Reunion")}}><Text>ajout d'une reunion</Text></TouchableOpacity>
